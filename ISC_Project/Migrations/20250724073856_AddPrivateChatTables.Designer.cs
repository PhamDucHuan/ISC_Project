...
namespace ISC_Project.Migrations
{
    ...
    [Migration("20250724073856_AddPrivateChatTables")]
    partial class AddPrivateChatTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISC_Project.Models.ChatConversation", b =>
                {
                    b.Property<int>("ChatConversationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("ChatConversation_ID");
                    ...
                    b.HasIndex(new[] { "UserId" }, "IX_ChatConversations_UserID");

                    b.ToTable("ChatConversations", "ISC_Project");
                });
            ...
            modelBuilder.Entity("ISC_Project.Models.ChatMessage", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChatConversationId" }, "IX_ChatMessages_ConversationID");

                    b.ToTable("ChatMessages", "ISC_Project");
                });
            ...
            modelBuilder.Entity("ISC_Project.Models.PrivateChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ISC_Project.Models.UserOnlineStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ISC_Project.Models.ChatMessage", b =>
                {
                    b.HasOne("ISC_Project.Models.ChatConversation", "ChatConversation")
            ...
            modelBuilder.Entity("ISC_Project.Models.PrivateChat", b =>
                {
                    b.HasOne("ISC_Project.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ISC_Project.Models.User", "Sender")
                        .WithMany()
